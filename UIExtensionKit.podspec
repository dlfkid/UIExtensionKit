#
#  Be sure to run `pod spec lint UIExtensionKit.podspec' to ensure this is a
...
+ (UIColor *)colorWithR:(CGFloat)red G:(CGFloat)green B:(CGFloat)blue Alpha:(CGFloat)alpha;
  ...
  spec.homepage     = "https://github.com/dlfkid/UIExtensionKit"
  ...
  spec.source       = { :git => "https://github.com/dlfkid/UIExtensionKit.git", :tag => spec.version.to_s }
  ...
  spec.source_files  = "UIColorExtensionDemo/UIColorExtensionDemo/ExtensionKit"
